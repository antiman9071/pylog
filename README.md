This is a program that is meant to help track capture the flag challenges and the methods taken to solve them. It also works with multiple challenges that can be filtered and searched through.
